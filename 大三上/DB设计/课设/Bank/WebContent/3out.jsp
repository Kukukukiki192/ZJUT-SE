...
<div class="container">
	<div><!-- 面包屑导航 -->
		<nav class="breadcrumb">
		  ...
		  <span class="breadcrumb-item active">取款</span>
		</nav>
	</div>
	<div class="row">
		...
		<div class="col-10"><!--内容-->
			...
			<div class="card">
			  	<div class="card-body">
					<form action="OutServlet" method="post" onsubmit="return Check()">
			      		<table class="table">
							<tr><td>账户号</td>
							...
							<tr><td>取出金额</td><td><input name="O_money" id="O_money" type="text" class="form-control" required></td></tr>	
							<tr><td>取款时间</td><td><div><div style="display:inline-block" id="displaydate"></div><div style="display:inline-block" id="displaytime"></div></div></td></tr>						
							<tr><td></td><td><button type="submit" class="btn btn-primary">确认</button>&nbsp;&nbsp;&nbsp;<button type="reset" class="btn btn-light">重置</button></td></tr>
						</table>
					</form>
				</div> 
				<div class="card-footer">
				    <button type="button" class="btn btn-default text-info" data-toggle="modal" data-target="#a">取款记录</button>
					  ...
					  <div class="modal-dialog modal-lg">
					    <div class="modal-content">
					      ...
					      <div class="modal-body">					       
						      	<table class="table">
						      		<tr align="left"><th>取款时间</th><th>取款账户</th><th>金额</th></tr>
						      		<c:forEach var="Out" items="${sessionScope.Outs}" varStatus="status">
									<tr align="left" class="table-success"><td>${Out.o_time}</td><td>${Out.a_id}</td><td>${Out.o_money}</td></tr>	
									</c:forEach>											
								</table>
					      </div>			    
					    </div>
