...
<div class="container">
	...
	<div class="col-7">		
		...
		<table border="1" id="tab">
			...
			<tr align="center"><td>${t.tno}</td><td>${t.tname}</td><td>${t.tsex}</td><td>${t.tage}</td><td>${t.title}</td><td>${t.phone}</td>
	...
	<div class="col-5">		
		<form action="C1addTServlet" method="post"> 
			...
			<tr align="left"><td>教师性别</td><td>
			<input name="tsex" type="radio" required/>男<input name="tsex" type="radio" />女
				</td></tr>
