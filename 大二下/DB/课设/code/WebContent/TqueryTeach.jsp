...
<div class="container-fluid">
	...
	<nav class="breadcrumb pull-right">
		...
		<span class="breadcrumb-item active">教师任课</span>
	</nav>
	<!--内容-->
	<div id="content">
		<h4>${result}</h4>
		<table border="1">
			<tr align="center"><th width="350">教师编号</th><th width="350">教师姓名</th><th width="350">课程编号</th><th width="350">课程名称</th></tr>
			<c:forEach var="List" items="${requestScope.List}">
			<tr align="center"><td>${List.tno}</td><td>${List.tname}</td><td>${List.cno}</td><td>${List.cname}</td></tr>
			</c:forEach>
		</table>	
	</div>
</div>
