...
<body><%int type=(Integer)request.getAttribute("type");%>
<div class="container">
	<!--页眉-->
	<div id="header">
		<header>
			...
			<div style="display:inline-block;float:right">
				<%	if(type==1) {  %>
				<a href="me.jsp?num=${student.num}&type=${type}">我</a>			
				<%	} else { %>
				<a href="me.jsp?num=${teacher.num}&type=${type}">我</a>
				<%	} %>
			...
			<div id="sidebar">
				<nav>
		            <ul class="nav flex-column">
		            	<%	if(type==1) {  %>
		            	<li class="nav-item"><a class="nav-link" href="index2.jsp?num=${student.num}&type=${type}">首页</a></li>
						<li class="nav-item"><a class="nav-link" href="clockin.jsp?num=${student.num}&type=${type}">每日填报</a></li>
						<li class="nav-item"><a class="nav-link" href="myCode.jsp?num=${student.num}&type=${type}">我的健康码</a></li>
						<%	} else { %>
						<li class="nav-item"><a class="nav-link" href="index2.jsp?num=${teacher.num}&type=${type}">首页</a></li>
						<li class="nav-item"><a class="nav-link" href="clockin.jsp?num=${teacher.num}&type=${type}">每日填报</a></li>
						<li class="nav-item"><a class="nav-link" href="myCode.jsp?num=${teacher.num}&type=${type}">我的健康码</a></li>
						<%	} %>
		            </ul>
		        </nav>
			</div>
