			...
			<div id="content">
				...
				<nav class="breadcrumb pull-right">
					<%	if(type==1 || type==2 && teacher.getCharacter().equals("普通教师")) { %>
				  	...
				  	<%	} %>				  	
				  	<span class="breadcrumb-item active">我的健康码</span>
				</nav><br>
		        <section>
		        <% if(type==1&&student.getCode().equals("无") || type==2&&teacher.getCode().equals("无")){ %>
		        ...
		        <% } else { %>
		        	...
		        	<!-- 显示我的名字 -->
		        	<%	String imgPath;	if(type==1)	{ %>
		        	<p align="center"><%=student.getName()%></p>
		        	<%	imgPath = "file/"+student.getNum()+".png"; } else { %>
		        	<p align="center"><%=teacher.getName()%></p>
		        	<%	imgPath = "file/"+teacher.getNum()+".png"; }	%>
		        	<p align="center"><img src=<%=imgPath%> alt="健康码" /></p><br>
		        	<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<mark><font color="green">绿码</font></mark>:可以进出校园;<mark><font color="yellow">
